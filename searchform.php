<section class="custom-searchform">
    <form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url(home_url('/')); ?>">
        ...
        <input type="text" class="search-field outline-light-gray" placeholder="Search News" value="<?php echo get_search_query(); ?>" name="s" id="s" />

        <button type="submit" id="searchsubmit" class="d-flex">
